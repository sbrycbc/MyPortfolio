  ...
  return (
    <div name='home' className='h-screen home-container'>
        ...
        <div className='max-w-[1000px] mx-auto px-2 flex flex-col justify-center hi-container'>
            ...
            <p className='text-[#6fc2b0] text-l font-bold py-4 max-w-[700px]'>I am a mother 😉 a wife 😍 a runner 🏃‍♂️ a cat lover 🐈‍⬛ with a big sense of humor ☕. Always willing to learn and open to innovations 🌏. Excited about working on ambitious projects 🎗 with positive people. For more info, feel free to contact me🍀🎶🍀</p>
            <div>
